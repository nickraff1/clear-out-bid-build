-- Stripe Connect payout readiness tracking.
-- This makes Stripe requirements visible to sellers/admins and lets payout
-- automation block with a useful reason before attempting a transfer.
