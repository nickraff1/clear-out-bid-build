-- Server-authorised pickup workflow actions for buyer/seller order pages.
-- Keeps order lifecycle changes out of brittle client-side RLS updates.
...
BEGIN
  ...
  IF _action = 'propose' THEN
    ...
    SET
      proposed_pickup_at = _proposed_pickup_at,
  ...
  ELSIF _action = 'accept' THEN
    ...
    UPDATE public.orders
    SET
      agreed_pickup_at = ord.proposed_pickup_at,
