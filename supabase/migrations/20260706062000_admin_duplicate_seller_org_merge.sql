-- Admin-only duplicate seller organisation diagnostics and controlled merge.
-- This migration does not auto-delete data. Admins must explicitly call the
-- merge RPC for a selected duplicate source and canonical target organisation.
